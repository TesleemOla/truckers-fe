    ...
    <section className="glass-card col-span-12 px-5 py-4 sm:px-6 sm:py-5 lg:col-span-5">
      <div className="mb-3 flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-2xl bg-primary-500/10 text-primary-300">
        ...
        <div className="text-right">
          ...
          <p className="text-[11px] text-slate-400">Total units</p>
        </div>
      </div>
